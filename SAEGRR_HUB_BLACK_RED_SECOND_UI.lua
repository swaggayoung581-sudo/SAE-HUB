...
do
    ...
    second.Size = UDim2.fromOffset(225, 285)
    second.Position = UDim2.new(0.5, 155, 0.5, -142)
    ...
    secondStroke.Color = Color3.fromRGB(255, 35, 55)
    ...
    secondGradient.Color = ColorSequence.new({
        ...
        ColorSequenceKeypoint.new(0.25, Color3.fromRGB(255, 25, 45)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 100, 110)),
        ColorSequenceKeypoint.new(0.75, Color3.fromRGB(255, 25, 45)),
    ...
    secondClose.BackgroundColor3 = Color3.fromRGB(75, 10, 15)
    ...
    eggList.Size = UDim2.new(1, -18, 1, -112)
    ...
    eggList.ScrollBarImageColor3 = Color3.fromRGB(255, 35, 55)
    ...
    secondOpen.TextColor3 = Color3.fromRGB(255, 65, 80)
    ...
    secondOpenStroke.Color = Color3.fromRGB(255, 30, 50)
